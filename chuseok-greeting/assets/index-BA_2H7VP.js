(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(e){var t=function(){return Promise.reject(Error(e+`: web`))};return t.isSupported=function(){return!1},t}var t=e(`loadFullScreenAd`),n=e(`showFullScreenAd`);e(`getTossShareLink`),e(`share`);var r={initialize:e(`TossAds.initialize`),attachBanner:e(`TossAds.attachBanner`)};e(`Notification.requestAgreement`),e(`Promotion.grantReward`),e(`Promotion.openContactsInvite`);var i=document.getElementById(`app`),a=document.getElementById(`toast`),o=`ait.v2.live.23e6232fe5c94da7`,s={},c=2500;function l(e){var t=document.getElementById(`adWaitBox`);if(!e){t&&t.parentNode.removeChild(t);return}t||(t=document.createElement(`div`),t.id=`adWaitBox`,t.setAttribute(`style`,`position:fixed;left:50%;bottom:calc(env(safe-area-inset-bottom,0px) + 28px);transform:translateX(-50%);background:rgba(25,31,40,.88);color:#fff;font-size:13px;padding:10px 16px;border-radius:999px;z-index:9999;pointer-events:none;white-space:nowrap`),t.textContent=`광고를 준비하고 있어요…`,document.body.appendChild(t))}function u(e,r){if(s[e])return s[e];var i=!1,a=!1,o=0,u=!1;function d(){try{return t.isSupported&&t.isSupported()}catch{return!1}}function f(){if(!(!d()||a||i)){a=!0;try{t({options:{adGroupId:e},onEvent:function(e){e.type===`loaded`&&(i=!0,a=!1,o=0)},onError:function(){a=!1,i=!1,o<8&&(o++,setTimeout(f,Math.min(1e3*o,5e3)))}})}catch{a=!1}}}function p(t){var a=!1,o=null;u=!0;function s(){a||(a=!0,u=!1,i=!1,o&&clearTimeout(o),f(),t())}try{o=setTimeout(s,r),n({options:{adGroupId:e},onEvent:function(e){clearTimeout(o),o=setTimeout(s,6e4),(e.type===`failedToShow`||e.type===`dismissed`)&&s()},onError:function(){s()}})}catch{s()}}function m(e){if(!d()||u){e();return}if(i){p(e);return}f();var t=0,n=100;l(!0);var r=setInterval(function(){t+=n,i?(clearInterval(r),l(!1),p(e)):t>=c&&(clearInterval(r),l(!1),e())},n)}return f(),s[e]={show:m},s[e]}var d=u(o,8e3),f=`ait.v2.live.3cbcbe6fbb16422c`,p=null,m=!1,h=!1,g=`init`;function _(){if(!m){m=!0;try{if(!r||!r.initialize||r.initialize.isSupported&&!r.initialize.isSupported())return;g=`wait`,r.initialize({callbacks:{onInitialized:function(){g=`ready`,h&&(h=!1,v())},onInitializationFailed:function(){g=`fail`}}})}catch{}}}function v(){try{if(!r.attachBanner||r.attachBanner.isSupported&&!r.attachBanner.isSupported())return;var e=document.getElementById(`bannerBox`);if(!e)return;p=r.attachBanner(f,e,{theme:`auto`,variant:`card`})}catch{}}function y(){try{p&&p.destroy&&p.destroy()}catch{}if(p=null,!m){h=!0,_();return}if(g===`wait`){h=!0;return}v()}var b={y:2026,m:9,d:25,label:`2026년 9월 25일 금요일`};function x(){var e=new Date,t=new Date(e.getFullYear(),e.getMonth(),e.getDate()),n=new Date(b.y,b.m-1,b.d);return{diff:Math.round((n-t)/864e5),label:b.label}}var S=[{key:`parent`,ic:`🏡`,name:`부모님·어른`,hint:`부모님, 시부모님, 친척 어른`,list:[{len:`짧게`,t:`아버지 어머니, 풍성한 한가위 보내세요.
...
귀성길 기차표 예매는 보통 연휴 한 달 전쯤 시작합니다.`}]}];function C(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function w(e){a.textContent=e,a.classList.add(`on`),clearTimeout(w._t),w._t=setTimeout(function(){a.classList.remove(`on`)},1500)}function T(e,t){function n(){t.textContent=`복사했어요`,t.classList.add(`done`),w(`복사했어요. 붙여넣기 하세요`),setTimeout(function(){t.textContent=`복사하기`,t.classList.remove(`done`)},2e3)}try{if(navigator.clipboard&&navigator.clipboard.writeText){navigator.clipboard.writeText(e).then(n,function(){r()});return}}catch{}r();function r(){try{var t=document.createElement(`textarea`);t.value=e,t.setAttribute(`readonly`,``),t.style.position=`fixed`,t.style.left=`-9999px`,document.body.appendChild(t),t.select(),t.setSelectionRange(0,e.length),document.execCommand(`copy`),document.body.removeChild(t),n()}catch{w(`길게 눌러 복사해 주세요`)}}}function E(){var e=x(),t,n;e.diff>0?(t=`D-`+e.diff,n=e.label):e.diff===0?(t=`오늘`,n=`한가위입니다. 풍성한 하루 되세요`):(t=`한가위가 지났어요`,n=`내년 추석은 2027년 9월 15일입니다`);var r=``;r+=`<div class="dday"><div class="moon"></div>`,r+=`<div class="lbl">2026 추석까지</div>`,r+=`<div class="num">`+C(t)+`</div>`,r+=`<div class="sub">`+C(n)+`</div></div>`,r+=`<div class="desc">보낼 상대를 고르면 그대로 복사해<br>카톡·문자로 보낼 수 있는 인사말이 나와요.</div>`,r+=`<div class="grid">`;for(var a=0;a<S.length;a++){var o=S[a];r+=`<button class="pick" data-i="`+a+`">`,r+=`<span class="ic">`+o.ic+`</span>`+C(o.name),r+=`<span class="hint">`+C(o.hint)+`</span></button>`}r+=`</div>`,r+=`<div class="adnote">버튼을 누르면 광고가 한 번 표시된 뒤 인사말이 나와요.</div>`,r+=`<div class="bannerbox" id="bannerBox"></div>`,r+=`<div class="foot">인사말은 자유롭게 고쳐 쓰셔도 됩니다.<br>로그인이나 개인정보 입력 없이 바로 쓸 수 있어요.</div>`,i.innerHTML=r,window.scrollTo(0,0),y();for(var s=i.querySelectorAll(`button.pick`),c=0;c<s.length;c++)s[c].addEventListener(`click`,function(){var e=parseInt(this.getAttribute(`data-i`),10);d.show(function(){D(e)})})}function D(e){var t=S[e],n=``;if(n+=`<div class="emoji">`+t.ic+`</div>`,n+=`<div class="who">`+C(t.name)+`</div>`,t.isInfo)for(var r=0;r<t.list.length;r++)n+=`<div class="sect"><b>`+C(t.list[r].len)+`</b>`+C(t.list[r].t).replace(/\n/g,`<br>`)+`</div>`;else{n+=`<div class="desc" style="margin-bottom:13px">복사하기를 누르면 그대로 붙여넣어 보낼 수 있어요.</div>`;for(var a=0;a<t.list.length;a++)n+=`<div class="msg"><div class="len">`+C(t.list[a].len)+`</div>`,n+=`<div class="txt">`+C(t.list[a].t)+`</div>`,n+=`<button class="cp" data-k="`+a+`">복사하기</button></div>`}n+=`<div class="bannerbox" id="bannerBox"></div>`,n+=`<button class="ghost" id="back">다른 상대 고르기</button>`,n+=`<div class="foot">문구는 상황에 맞게 고쳐 쓰셔도 됩니다.</div>`,i.innerHTML=n,window.scrollTo(0,0),y();for(var o=i.querySelectorAll(`button.cp`),s=0;s<o.length;s++)o[s].addEventListener(`click`,function(){var e=parseInt(this.getAttribute(`data-k`),10);T(t.list[e].t,this)});document.getElementById(`back`).addEventListener(`click`,E)}E();